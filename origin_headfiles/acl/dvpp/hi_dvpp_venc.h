...
/* operation is not permitted ,eg, try to change status's attribute */
...
typedef struct {
    ...
    hi_u32                 intra4_mb_num; // R; the intra4x4 macroblock num
...
// Defines the features of a jpege stream
typedef struct {
    hi_u32 pic_bytes; // R; the coded picture stream byte number
...
typedef struct {
    ...
    hi_u32  pic_bytes; // R;the coded picture stream byte number
    hi_u32  pic_cnt; // R;When channel attribute 'is_by_frame == 1', it means count of frames.
                     // When channel attribute 'is_by_frame == 0', it means count of packets
    hi_u32  start_qp; // R;the start Qp of encoded frames
    hi_u32  mean_qp; // R;the mean Qp of encoded frames
    hi_bool is_p_skip;
...
typedef struct {
    ...
    hi_u32      stats_time; // RW; Range:[1, 60]; the rate statistic time, the unit is second(s)
...
typedef struct {
    hi_u32      gop; // RW; Range:[1, 65536]; the interval of I SLICE.
    hi_u32      stats_time; // RW; Range:[1, 60]; the rate statistic time, the unit is second(s)
    hi_u32      src_frame_rate; // RW; Range:[1, 240]; the input frame rate of the venc channel
    hi_u32      dst_frame_rate; // RW; Range:[1, 240]; the target frame rate of the venc channel,
                                  // can not be larger than src_frame_rate
...
typedef struct {
    ...
    hi_u32      short_term_stats_time; // RW; Range:[1, 120]; the short-term rate statistic time,
                                      // the unit is second (s)
    hi_u32      long_term_stats_time; // RW; Range:[1, 1440]; the long-term rate statistic time,
                                     // the unit is long_term_stats_time_unit
...
typedef struct {
    hi_bool color_to_grey_en; // RW; Range:[0, 1]; Whether to enable ColorToGrey
...
typedef struct {
    ...
    hi_u32  long_term_stats_time_unit; // RW; Range:[1, 1800]; the time unit of long_term_stats_time,
                                     // the unit is second(s)
    hi_bool save_bitrate_en;
...
typedef struct {
    ...
    hi_u32  long_term_stats_time_unit; // RW; Range:[1, 1800]; the time unit of LongTermStatsTime,
                                     // the unit is second(s)
...
typedef struct {
    ...
    hi_bool adapt_insert_idr_frame_en;  // RW; Range:[0, 1]; enable adaptive insertIDR frame.
...
/* The param of the vui aspect ratio */
typedef struct {
...
/* The param of the cu prediction struct */
typedef struct {
...
/*
 * @brief release stream from video encoder channel
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
...
/*
 * @brief get the predicted buffer size for a jpege frame
 * @param [in] frame: pointer of frame struct
 ...
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] chn_param: pointer of video encoder channel parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get channel's parameters
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] chn_param: pointer of video encoder channel parameter struct
 * @return success: return 0
 *         fail: return error number
 */
 ...
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] rc_param: pointer of rate control parameter struct
 * @return success: return 0
 *         fail: return error number
 */
 ...
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] rc_param: pointer of rate control parameter struct
 * @return success: return 0
 *         fail: return error number
 */
 ...
 * @brief set roi attr
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] roi_attr: pointer of roi attr struct
 * @return success: return 0
 *         fail: return error number
 */
 ...
 * @brief get roi attr
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] idx: index of roi region
 * @param [out] roi_attr: pointer of roi attr struct
 * @return success: return 0
 *         fail: return error number
 */
 ...
 * @brief set ref param
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] ref_param: pointer of ref param struct
 * @return success: return 0
 *         fail: return error number
 */
 ...
 * @brief get ref param
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] ref_param: pointer of ref param struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get encoding scene mode
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] scene_mode: pointer of scene mode struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief set h264 vui parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] h264_vui: pointer of h264 vui parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get h264 vui parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] h264_vui: pointer of h264 vui parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief set h265 vui parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] h265_vui: pointer of h265 vui parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get h265 vui parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] h265_vui: pointer of h265 vui parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief set cu prediction parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] cu_pred: pointer of cu prediction parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get cu prediction parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] cu_pred: pointer of cu prediction parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief set intra refresh reference parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] intra_refresh: pointer of p slice intra refresh parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get intra refresh reference parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] intra_refresh: pointer of p slice intra refresh parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief set the attribute of venc chn
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] chn_attr: pointer of venc chn attribute struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get the attribute of venc chn
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] chn_attr: pointer of venc chn attribute struct
 * @return success: return 0
 *         fail: return error number
 */
hi_s32 hi_mpi_venc_get_chn_attr(hi_venc_chn chn, hi_venc_chn_attr *chn_attr);
/*
 * @brief set slice split reference parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] slice_split: pointer of venc slice split parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get slice split reference parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] slice_split: pointer of venc slice split parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief set stream copy parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [in] streamcopy_param: pointer of stream copy parameter struct
 * @return success: return 0
 *         fail: return error number
 */
...
/*
 * @brief get stream copy parameter
 * @param [in] chn: video encoder channel id [0, VENC_MAX_CHN_NUM)
 * @param [out] slice_split: pointer of stream copy parameter struct
 * @return success: return 0
 *         fail: return error number
 */
