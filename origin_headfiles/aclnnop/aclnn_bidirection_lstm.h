 ...
 * numLayersOptional : optional
 * isbiasOptional : optional
 * batchFirstOptional : optional
 * bidirectionOptional : optional
 * yOut : required
 * outputHOut : required
 * outputCOut : required
...
aclnnStatus aclnnBidirectionLSTMGetWorkspaceSize(
    ...
    int64_t numLayersOptional,
    bool isbiasOptional,
    bool batchFirstOptional,
    bool bidirectionOptional,
