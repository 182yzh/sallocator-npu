 ...
 * queryTransposeOptional : optional
 * keyTransposeOptional : optional
 * valueTransposeOptional : optional
 * softmaxAxesOptional : optional
 * out : required
...
aclnnStatus aclnnSwinAttentionScoreQuantGetWorkspaceSize(
    ...
    bool queryTransposeOptional,
    bool keyTransposeOptional,
    bool valueTransposeOptional,
    int64_t softmaxAxesOptional,
    const aclTensor *out,
