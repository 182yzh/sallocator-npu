 ...
 */
ACLNN_API aclnnStatus aclnnUpsampleLinear1dBackward(void* workspace, uint64_t workspace_size, aclOpExecutor* executor,
                                                    aclrtStream stream);
...
#endif  // OP_API_INC_UNAMPLE_LINEAR_1D_BACKWARD_H_